...
void run_storage_tests() {
    {
        ...
        scpp::compile_to_executable(
            ...
            "public:\n"
            "    virtual ~Box() = default;\n"
            "    scpp::storage_for<int, long> slot;\n"
            ...
            "    if ((int)sizeof(scpp::storage_for<int, long>) != 8) return 2;\n"
...

    {
        ...
        scpp::compile_to_executable(
            ...
            "struct Wrapper {\n"
            "    char lead;\n"
            "    scpp::storage_for<Widget, int> storage;\n"
            "};\n"
            "int main() {\n"
            "    if ((int)sizeof(scpp::storage_for<Widget, int>) != 16) return 1;\n"
