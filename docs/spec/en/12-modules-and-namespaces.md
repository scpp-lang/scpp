...
[← Previous: Inheritance and Interfaces](11-inheritance-and-interfaces.md) · [Table of Contents](README.md) · [Next: Fundamental types and standard conversions →](13-fundamental-types.md)
