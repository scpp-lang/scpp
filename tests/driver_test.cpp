...
void run_io_tests() {
    {
        std::string case_name = "scpp_io_read_line_reads_one_line_without_newline";
        cases_run++;
        RunResult result = compile_and_run_with_input(
            R"SCPP(import std;
import scpp;
int main() {
    auto line = scpp::io::read_line();
    ...
    {
        std::string case_name = "scpp_io_read_line_returns_eof_error_on_empty_input";
        cases_run++;
        RunResult result = compile_and_run_with_input(
            R"SCPP(import std;
import scpp;
